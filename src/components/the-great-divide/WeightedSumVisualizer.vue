      ...
      <div class="space-y-4">
        ...
        <div class="flex gap-4 items-center justify-between flex-wrap mt-auto pt-6">
          ...
          <button
            ...
            class="px-4 py-2 bg-slate-800 text-white text-sm rounded font-medium hover:bg-slate-700 transition-colors"
          >
          ...
          <button
            @click="reset"
            class="px-4 py-2 border border-slate-300 text-slate-700 text-sm rounded font-medium hover:bg-slate-50 transition-colors"
          >
            ↻ Reset
          </button>
        </div>
