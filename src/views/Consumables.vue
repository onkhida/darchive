      ...
      <nav class="container mx-auto max-w-3xl px-4 md:px-8 pt-16">
        <div class="flex justify-between items-center">
          ...
          <div class="flex space-x-3 sm:space-x-6 text-sm">
            ...
            <router-link to="/consumables" class="transition-colors" :class="isDark ? 'text-primary-400 hover:text-primary-100' : 'text-primary-600 hover:text-primary-900'">Consumables</router-link>
          </div>
        </div>
      </nav>
      ...
      <main class="container mx-auto px-4 md:px-8 py-10 max-w-3xl">
        ...
        <section class="mb-12">
          ...
          <p class="leading-relaxed mb-8" :class="isDark ? 'text-primary-300' : 'text-primary-700'">
            This section exists to extend the limits of my <a href="https://letterboxd.com/onkhida/">Letterboxd</a> and <a href="https://www.goodreads.com/onkhida">Goodreads</a>. This was originally to be titled, "readings" to give me a space to log thoughts about the texts that I am most engaged with, but I've (of recent) taken a liking to film, and I now want to document my interactions with moving pictures as well. A lot of this is recreational. Away from what is formally positioned as work, I've just thought to centralise my engagements with the things I find myself consuming.
          </p>
        </section>
